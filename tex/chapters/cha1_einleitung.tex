...
Diese Makromoleküle setzen sich wiederum aus vielen kleineren, sich wiederholenden Molekülen, in diesem Zusammenhang \emph{Monomere} genannt, zusammen.
...
Weiter interessieren wir uns nur für Copolymere, vor allem die sogenannten Blockcopolymere, welche aus mehreren Monomer-Gattungen, die homogene zusammenhängende Blöcke bilden, aufgebaut sind (siehe Abbildung \ref{figure:polymerketten}).

\begin{figure}[tb]
    \begin{captionbeside}[Skizzenhafte Darstellung verschiedener Polymerarten.]{%
    ...
    \includegraphics[width=0.6\textwidth]{figures/chapter1/copolys.pdf}
    \end{captionbeside}
...
So neigen die Gemische vieler Paare von Homopolymeren zu makroskopischer Phasenseparation, wie man es beispielsweise auch von Öl und Wasser kennt.
...
\begin{figure}[tb]
    ...
    \begin{subfigure}[b]{0.14\textwidth}
        \includegraphics[width=\textwidth]{figures/chapter1/phase1.eps}
    \end{subfigure}
    \begin{subfigure}[b]{0.14\textwidth}
        \includegraphics[width=\textwidth]{figures/chapter1/phase2.eps}
    \end{subfigure}
    \begin{subfigure}[b]{0.14\textwidth}
        \includegraphics[width=\textwidth]{figures/chapter1/phase3.eps}
    \end{subfigure}
    \begin{subfigure}[b]{0.14\textwidth}
        \includegraphics[width=\textwidth]{figures/chapter1/phase4.eps}
    \end{subfigure}
    \begin{subfigure}[b]{0.14\textwidth}
        \includegraphics[width=\textwidth]{figures/chapter1/phase5.eps}
    \end{subfigure}
...
\paragraph{Mathematische Modellierung.} % (fold)
...
Diese Wechselwirkungen können in Abbildung \ref{figure:kettenmodelle} beispielsweise als Einschränkung des Winkels $\vartheta_9$ durch die gegenseitige Beeinflussung der Partikel $8, 9$ und $10$ auftreten.
...
\begin{figure}[tb]
    \begin{captionbeside}[Polymerkette in diskretem und Gaußschem Kettenmodell.]{%
        ...
        \includegraphics[width=0.5\textwidth]{figures/chapter1/chainmodell.pdf}
    \end{captionbeside}
...
\paragraph{Einsatz numerischer Methoden.} % (fold)
...
\begin{figure}[tb]
    ...
    \begin{subfigure}[b]{0.485\textwidth}
        \centering
        \includegraphics[width=1\textwidth]{figures/chapter1/scft1.pdf}
        \caption{Felder}
    \end{subfigure}
    % ~
    \begin{subfigure}[b]{0.485\textwidth}
        \centering
        \includegraphics[width=1\textwidth]{figures/chapter1/scft2.pdf}
        \caption{Fourier-Koeffizienten}
    \end{subfigure}
    \\
    \begin{subfigure}[b]{0.485\textwidth}
        \centering
        \includegraphics[width=1\textwidth]{figures/chapter1/scft_example2_fields.pdf}
        \caption{Felder}
    \end{subfigure}
    % ~
    \begin{subfigure}[b]{0.485\textwidth}
        \centering
        \includegraphics[width=1\textwidth]{figures/chapter1/scft_example2_fourier_coeffs.pdf}
        \caption{Fourier-Koeffizienten}
    \end{subfigure}
    \caption[%
    Eindimensionale Beispiele einer stabilen Anordnung eines Diblockcopolymers.
    ]{%
        Eindimensionale Beispiele einer stabilen Anordnung eines Diblockcopolymers, welche mittels \ac{scft} und Pseudospektralverfahren bestimmt wurden.
        Das obere Beispiel wurde auf einem Intervall der Länge $L = 10$ mit den relevanten Größen $f = 1/2$, $\chi N = 25$ und $a^{2} N / 6 = 10 / 3$ simuliert.
        Für das untere Beispiel wurde lediglich $f$ auf den Wert $1/3$ geändert.
