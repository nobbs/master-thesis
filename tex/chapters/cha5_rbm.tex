...
Die Orthonomalisierung wird durchgeführt, da a priori nicht sichergestellt werden kann, dass die Snapshots $u_{\mathcal N}(\bm \sigma_n)$ nicht nahezu linear abhängig sind.
...
\begin{onoffdescription}
    ...
    Dies entspricht $N \cdot Q_b$ Matrix-Matrix-Multiplikation der Größe $\mathcal N \times \mathcal N$.
