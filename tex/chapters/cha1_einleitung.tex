...
% TODO: zu einer Graphik mit Sidecap machen
\begin{SCfigure}[][tb]
    \centering
...
\begin{figure}[tb]
    ...
    \begin{subfigure}[b]{0.485\textwidth}
        \centering
        \includegraphics[width=1\textwidth]{figures/einleitung/scft_example2_fields.pdf}
        \caption{Felder}
    \end{subfigure}
    % ~
    \begin{subfigure}[b]{0.485\textwidth}
        \centering
        \includegraphics[width=1\textwidth]{figures/einleitung/scft_example2_fourier_coeffs.pdf}
        \caption{Fourier-Koeffizienten}
    \end{subfigure}
    \caption[%
