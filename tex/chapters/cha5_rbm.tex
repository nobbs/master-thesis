...
Dies ist die Grundidee der RB"=Methoden, die in Abbildung \ref{figure:rbm_loesungsmenge} noch einmal skizzenhaft veranschaulicht wird.

\begin{figure}[tb]
    \begin{captionbeside}[Skizze zur Motivation der Reduzierte"=Basis"=Methode.]{%
        ...
        \includegraphics[width=0.55\textwidth]{figures/chapter5/rb.pdf}
    \end{captionbeside}
...
Wir konzentrieren uns dabei hauptsächlich auf ein einfaches Beispiel mit einem eindimensionalen Parameterraum, da dies die beste Möglichkeit bietet, das Verhalten der Reduzierte"=Basis"=Methode zu veranschaulichen.
...
Diese Wahl lässt sich durch die beispielhaften Ergebnisse aus der \nameref{chapter:einleitung} rechtfertigen, da dort gut erkennbar ist, dass die Felder sowohl eine hohe Regularität als auch Symmetrien ausweisen.
...
\begin{table}[tb!]
    \begin{captionbeside}[Entwicklung der maximalen relativen Spanne bei der \ac{scm}, erstes Beispiel.]{%
...
\end{equation}
für $\alpha = \beta^{2}$ kann in Tabelle \ref{table:entwicklung_scm_abweichung} abgelesen werden.
...
\cref{figure:entwicklung_rbm_fehler} und Tabelle \ref{table:entwicklung_rbm_2} zeigen die Entwicklung des a posteriori"=Fehlerschätzers.
...
\begin{figure}[tb!]
    ...
    \caption[Entwicklung des Maximums des a posteriori"=Fehlerschätzers für steigendes $N$, zweites Beispiel.]{%
        ...
        Siehe auch Tabelle \ref{table:entwicklung_rbm_2}.
        }
    \label{figure:entwicklung_rbm_fehler}
\end{figure}

\begin{table}[tb!]
    \begin{captionbeside}[Entwicklung des Maximums des a posteriori"=Fehlerschätzers für einige $N$, zweites Beispiel.]{%
            Entwicklung des Maximums des a posteriori"=Fehlerschätzers für steigendes $N$ beim zweiten Beispiel.
