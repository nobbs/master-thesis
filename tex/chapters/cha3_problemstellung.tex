...
\mfix{Den Quatsch hier mal ordentlich formulieren und formatieren.}
\begin{Korollar}
...
\mdo{Und daraus folgt dann die \enquote{analytisch in $\sigma$}?.}
...
\begin{Beweis}[\cref{satz:ps:rg:kunoth13_theorem21}]
