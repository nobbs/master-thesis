...
Wir orientieren uns dabei maßgeblich an \cite{Dautray:1992by,Lions:1972tg}.
...
\label{definition:gl:gelfand_tripel}
    ...
    Durch Identifikation von $H$ mit seinem Dualraum $H'$ erhalten wir das sogenannte \emph{Gelfand-Tripel}
    \begin{equation}
