...
% Unterräume $\mathcal X_N$ und $\mathcal Y_N$ approximiert.
...
% Die Dimensionen von $\mathcal X_N$ und $\mathcal Y_N$ müssen gleich sein
% um eine quadratische Steifigkeitsmatrix zu erhalten. (Wünschenswert!)
...
% näher zu bestimmenden Größe) preallokiert werden.
idx = [];
idy = [];
entry = [];
