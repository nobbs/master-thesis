...
Mit dieser Vorarbeit können wir die schwache Formulierung aus \thref{definition:cha3:schwache_formulierung} nun zu der folgenden parametrischen schwachen Formulierung ausweiten.
...
\label{satz:pp:lax_auf_elliptisch}
    ...
    \begin{Beweis}
        Folgt direkt aus dem Lemma vom Lax-Milgram, \thref{lemma:gl:lax_milgram}.
    \end{Beweis}
\end{Satz}
...
Die in den Beweisen von \thref{satz:cha3:existenz_part_ableitung} und \thref{satz:cha3:part_ableitung_schranke} angewandten Schritte lassen sich, solange die Wohldefiniertheit aller Ausdrücke gegeben ist, analog auch für allgemeinere parametrisch affine Operatoren respektive Bilinearformen nachweisen.
