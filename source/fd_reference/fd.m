...
[B1, B2, F] = assemble(Nx, kind, xspan);
...
function [B1, B2, F] = assemble(Nx, kind, xspan)
...
switch kind
  case 'homogen'
    ...
    B2 = assemble_omega_from_vector(Nx, kind, omega(xgrid(2:end-1)));
  ...
  case 'periodic'
    ...
    % Zweiter Anteil: "Reaktion"
    B2 = assemble_omega_from_vector(Nx, kind, omega(xgrid(1:end-1)));
