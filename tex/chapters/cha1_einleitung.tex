...
\begin{SCfigure}[][tb]
    \centering
    \includegraphics[width=0.5\textwidth]{figures/chapter1/copolys.pdf}
...
\begin{SCfigure}[][tb]
    \centering
        \includegraphics[width=0.55\textwidth]{figures/chapter1/chainmodell.pdf}
    \caption[%
        Polymerkette in diskretem und Gaußschem Kettenmodell.
    ]{%
